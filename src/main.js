      ...
      <div class="header-inner">
        ...
        <div class="info-wrap">
          ...
          <div class="info-card" role="tooltip">
            ...
            <p class="info-desc">A clean, open-source emoji browser. No tracking, no ads, no telemetry — just emojis. All data is bundled locally.</p>
            <a class="info-link" href="https://github.com/totoro-light/emoji-icons" target="_blank" rel="noopener noreferrer">
